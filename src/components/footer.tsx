...
import { contact, navigation } from "@/config/contact";
        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:pr-8">
            ...
            <p className="mt-3 text-sm text-[var(--muted)] leading-relaxed">
              AI-powered product visuals for ecommerce brands. Photo, video, and AI generation — all in one studio.
            </p>
          </div>
            ...
            <div className="flex items-center gap-4">
              {socialIcons.map((social) => (
                <a
                  ...
                  className="text-[var(--muted)] transition-all duration-200 hover:text-[var(--amber)] hover:scale-110"
                >
                  {social.svg}
                </a>
              ))}
